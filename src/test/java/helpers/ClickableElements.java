...
//    BUTTON_SELECT_PAYMENT(MainPage.selectPaymentButton, MainPage::new, "'Кнопка выпадающий списка видов оплат'"),
//    BUTTON_SUBMIT_REPLENISHMENT(MainPage.submitButton, PaymentDataPage::new, "'Кнопка подтверждения платежа'"),
//    LINK_MORE_ABOUT_THE_SERVICE(MainPage.moreAboutTheServiceLink, MoreAboutReplenishmentPage::new, "'Ссылка на страницу о сервисе оплаты'"),
//    PAYMENT_DATA_PAGE_PAY_BUTTON(PaymentDataPage.submitButton, PaymentDataPage::new, "'Кнопка подтверждения платежа'");
//
//    final WebElement element;
//    final Supplier<? extends BaseSeleniumPage> pageSupplier;
//    final String elementName;
//
//    <T extends BaseSeleniumPage> ClickableElements(WebElement webElement,
//                                                   Supplier<T> pageSupplier,
//                                                   String elementName) {
